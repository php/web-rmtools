...
set PHP_RMTOOLS_LOCK_PATH=%PHP_RMTOOLS_LOCK_PATH%\locks
set PHP_RMTOOLS_LOG_PATH=%PHP_RMTOOLS_LOG_PATH%\logs
set PHP_RMTOOLS_TMP_PATH=%PHP_RMTOOLS_LOG_PATH%\tmp
